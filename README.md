...
`알고리즘` `자료구조` `JPA(기존)` `Spring DataJPA` `Junit 5 및 TDD` `H2 Database` `AOP` `Java Doc` `디자인 패턴[예정]` `MSA (Micro Service Architecture)[예정]` `AWS EC2[예정]` `Docker[예정]` `기타 Spring 각종 고급기술[예정]` `이펙티브자바[예정]`
